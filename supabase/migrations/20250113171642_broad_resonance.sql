/*
  # Fix is_read column and schema cache

  1. Changes
    - Drop and recreate is_read column with proper constraints
    - Update RLS policies to include is_read
    - Force schema cache refresh
    
  2. Security
    - Grant proper permissions for authenticated users
    - Ensure RLS policies cover is_read operations
*/

-- Temporarily disable RLS to perform maintenance
