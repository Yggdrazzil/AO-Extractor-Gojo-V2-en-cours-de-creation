/*
  ...
  1. Changes
    - Clean up previous attempts at adding is_read column
    - Add is_read column with proper constraints and defaults
...
-- Add the column fresh with NOT NULL constraint
